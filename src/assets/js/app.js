$(document).ready(function () {
  ...
  $(".carousel-section__item").each(function () {
    ...
    function setSwiperIndex(swiperInstance) {
      ...
      counterTotal.text(
        setActiveIndex(
          Math.ceil(swiperInstance.slides.length / swiperInstance.params.slidesPerView)
        )
      );
    }
    ...
    carousel.on("activeIndexChange", function () {
      counterActive.text(
        setActiveIndex(
          Math.ceil(
            (carousel.activeIndex + carousel.params.slidesPerView) /
              carousel.params.slidesPerView
          )
        )
      );
    });
...
let siteJS = {
  ...
  lightSelect: function () {
    ...
    const carrierDeliveryDepartment = document.querySelector(
      ".carrier-delivery-department"
    );
  ...
  tableSub() {
    ...
    tableSubContentBtn.click(function () {
      ...
      $(this)
        .closest(".table__row-sub")
        .prev(".table__row--toggler")
        .removeClass("table__row--toggler--active");
  ...
  productGrid() {
    ...
    if ($(document.body).hasClass("hover-device") && !tile.hasClass("size-watch")) {
      ...
      $(document.body).hasClass("touch-device") &&
      !tile.hasClass("size-watch")
    ) {
  ...
  filterSidebar() {
    ...
    $(document.body).append(
      `<div class="sb-filter-overlay ${isBlogPage} sidebar-toggle"></div>`
    );
  ...
  selectAlt() {
    ...
    collection.each(function () {
      $(this)
        .find(".select-alt__textbox-value")
  ...
  headerDropdown() {
    if ($(document.body).hasClass("hover-device")) {
      ...
      $(".header__controls-item .header__controls-btn").click(function () {
        const dropdown = $(this)
          .closest(".header__controls-item")
          .find(".header__controls-dropdown");
        if (dropdown.length) {
